package com.stingray.exampledatabase;
...
import com.stingray.exampledatabase.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText databaseName = (EditText) findViewById(R.id.databaseNameInput);
        final EditText tableNameInput = (EditText) findViewById(R.id.tableNameInput);

        Button createDatabaseBtn = (Button) findViewById(R.id.createDbBtn);
        ...
        createTableBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tbName = createTableBtn.getText().toString();
                createTable(tbName);
                int count = insertRecord(tbName);
                println(count + " recoids inserted.");
            }
        });
